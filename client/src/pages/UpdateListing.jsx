...
export default function UpdateListing() {
    ...
    useEffect(() => {
        const fetchListing = async () => {
            ...
            if (!listing.success) {
                setError(listing.errorMessage);
                return;
            }
            setFormData({ ...formData, ...listing.listing });
        }
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            if (formData.imageUrls.length < 1) return setError("You must upload atlease one image");
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80' type='button' disabled={uploading}>{uploading ? "Uploading..." : "Upload"}</button>
                    </div>
